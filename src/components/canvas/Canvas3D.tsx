...
import { createBodyMesh, updateBodyMeshes, removeBodyMesh, bodyMeshMap } from '../../rendering/threejs/bodies';
import { createReferencePlane, updateRefPlaneOrientation, resizeRefPlane, addOrbitRing, clearOrbitRings } from '../../rendering/threejs/grid';
import { getPlacementPoint, setBodyHighlight, createPreviewSphere, updateGuideArrow, removeGuideArrow, createFloatingPreview, removeFloatingPreview } from '../../rendering/threejs/interaction';
...
import { setSharedCamera, setSharedCanvas, setObservationTargetId, setCurrentLookAt, getCurrentLookAt, setSharedScene, setClickPosRender, getObservationTargetId } from '../../rendering/threejs/cameraRef';
import { initTouchInteraction, destroyTouchInteraction } from '../../rendering/threejs/touchInteraction';
import type { SceneSetup } from '../../rendering/threejs/setup';
