...
地月页面优先面向 6 岁儿童，时间轴采用低阅读负担的控制方式：
- 提供大尺寸播放/暂停按钮。
- 提供“慢慢转”和“快快转”两档速度，不在主界面暴露秒、小时等倍率单位。
- 提供“前进一天”按钮，便于儿童主动寻找月相变化。
- 当前日期作为辅助信息显示，不作为主要操作目标。
- 月食预报仍支持点击日期跳转，作为扩展科学内容保留。

#### 4.4.10.1 儿童探索任务

页面提供三个按顺序完成的短任务，每次只突出一个操作目标：

1. **找到月亮**：提示儿童点击场景中的月球；选中月球后完成。
2. **变出满月**：提示儿童使用时间控制观察月相；当前月相进入“满月”时完成。
3. **发现月食**：提示儿童从月食预报选择日期；当前月食状态不为 `none` 时完成。

任务卡使用短句、图标和进度点呈现。完成任务时显示明确的正向反馈，并由儿童主动进入下一任务，避免界面自动跳转造成困惑。全部完成后显示“月亮小专家”结果卡。

#### 4.4.10.2 儿童化科学说明

- 月相面板以月相图标、名称和一句解释为主，例如“太阳照亮了月亮朝向我们的这一面”。相位角等专业参数不在主界面展示。
- 月食状态优先使用“月亮还没有走进地球的影子”等儿童语言，专业名称作为副标题保留。
- 场景增加固定光照说明，明确太阳光从画面中太阳所在方向照向地球和月球。
- 所有关键按钮的触控区域不小于 48px，并适配桌面、平板和窄屏。
